...
C  ------------------------------------------------------------------------------
      SUBROUTINE convex(m,n,mn1,mn2) !ARGU = NDAT 
C  ------------------------------------------------------------------------------
...
!      E1=E1/0.3048d0 !To convert m to feet
!      E2=E2/0.3048d0 !To convert m to feet
!      XL=XL/0.3048d0 !To convert m to feet      
C ---------------------------------------------------------------------------------- 
      WRITE(NUT,901)NA
