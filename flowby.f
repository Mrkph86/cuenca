...
C ---------------------------------------------------------------------------------------
      SUBROUTINE flowby(m,n,mn1,mn2) !   (8.29.18)
C ---------------------------------------------------------------------------------------
...
C CONVERSION
C ---------------------------------------------------------------------------------------
!      QCAP=(QCAP)/(0.3048d0**3)!To obtain QCAP in CFS, The book works with
	  !!this units
       CALL MREAD(NA,A)
...
C ---------------------------------------------------------------------------------------
      !Hydro(I,3)=(Z-QCAP)
      !Hydro(I,3)=(Z-QCAP)*(0.3048d0**3)!To obtain in m^3/S (1.26.18)
C ---------------------------------------------------------------------------------------
...
C CONVERSION
C ---------------------------------------------------------------------------------------
      !Hydro(I,3)=B(I)*(0.3048d0**3)!To obtain in m^3/S
	  !Hydro(I,3)=B(I)
C ---------------------------------------------------------------------------------------     
...
!      Hydro(I,2)=A(I)*(0.3048d0**3)!To obtain in m^3/S
!      Hydro(I,2)=A(I)
!      END IF
