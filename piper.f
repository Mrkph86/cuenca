...
10    B(I)=0.d0
      ...
      STORE=0.d0
      S=SQRT((E1-E2)/XL)
      QCAP=35.628d0/XN*.013d0*S*D**2.6667d0
      NUMBER=A(600)
      VCAP=QCAP/.7854d0/D/D
      XA=XL/300.d0
      XB=300.d0/43560.d0
      WRITE(NUT,905)
...
C ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
      DO 550 I=1,576
      IF(I.GT.NUMBER.AND.STORE.LT..001d0)GO TO 1000
      Q=A(I)
...
510   QQ=Q/QCAP
      ...
      V=(QQ-F(INDEX,1))/.05d0*(F(INDEX+1,2)-F(INDEX,2))+F(INDEX,2)
      V=V*VCAP
